...
El Cliente y Usuario no podrá introducir ni tratar en el Servicio datos de carácter personal. A todos los efectos, el usuario será el único responsable del incumplimiento de esta prohibición.
